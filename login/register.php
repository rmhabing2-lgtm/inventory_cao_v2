<!--  Database: inventory_cao Table: user -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="app-brand justify-content-center">
                                    <a href="index.html" class="app-brand-link gap-2">
                                        ...
                                        <span class="app-brand-text demo text-body fw-bolder">CAO I-M-S</span>
                                    </a>
                                </div>
                                <!-- /Logo -->
                                ...
                                <p class="text-center">
                                    <span>By proceeding, you agree to the <a href="javascript:void(0);">Terms and Conditions</a></span>
                                </p>
                                <p class="text-center">
